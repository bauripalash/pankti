...
#define PANKTI_VERSION_BASE                                                    \
    ...
    "." PANKTI_STRINGIFY(PANKTI_VERSION_MINOR) "." PANKTI_STRINGIFY(           \
        PANKTI_VERSION_PATCH                                                   \
    )

// Get version as hex
#define PANKTI_VERSION_AS_HEX                                                  \
    ((PANKTI_VERSION_MAJOR << 16) | (PANKTI_VERSION_MINOR << 8) |              \
     PANKTI_VERSION_PATCH)
...
static inline int PanktiVersionGetHex(void) { return PANKTI_VERSION_AS_HEX; }
