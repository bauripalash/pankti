...
static PValue math_Sqrt(PInterpreter *it, PValue *args, pusize argc) {
...
static PValue math_Log10(PInterpreter *it, PValue *args, pusize argc) {
	PValue * rawVal = &args[0];
	if (rawVal->type != VT_NUM) {
		// MakeError
		return MakeNil();
...
static PValue math_Log(PInterpreter *it, PValue *args, pusize argc) {
	PValue * rawVal = &args[0];
	if (rawVal->type != VT_NUM) {
		// MakeError
		return MakeNil();
...
static PValue math_LogBase(PInterpreter *it, PValue *args, pusize argc) {
...
static PValue math_GCD(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_LCM(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Sine(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Cosine(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Tangent(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Degree(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Radians(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Number(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Abs(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Round(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Floor(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
static PValue math_Ceil(PInterpreter *it, PValue *args, pusize argc) {
	return MakeNil();
}
