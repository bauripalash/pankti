...
pub fn bnmath_Pi(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 0) {
    ...
    return enmod.math_Pi(gc, argc, values);
}

pub const BnNameFuncE = &[_]u32{0x0987};
pub fn bnmath_E(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 0) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_E(gc, argc, values);
}

pub const BnNameFuncSqrt = &[_]u32{ 0x09ac, 0x09b0, 0x09cd, 0x0997, 0x09ae, 0x09c2, 0x09b2 };
pub fn bnmath_Sqrt(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Sqrt(gc, argc, values);
}

pub const BnNameFuncLog10 = &[_]u32{ 0x09b2, 0x0997, 0x09a6, 0x09b6 };
pub fn bnmath_Log10(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Log10(gc, argc, values);
}
...
pub fn bnmath_Log(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Log(gc, argc, values);
}

pub const BnNameFuncLogX = &[_]u32{ 0x09b2, 0x0997, 0x09ac, 0x09c7, 0x09b8 };
pub fn bnmath_LogX(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 2) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_LogX(gc, argc, values);
}
...
pub fn bnmath_Gcd(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 2) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Gcd(gc, argc, values);
}

pub const BnNameFuncLcm = &[_]u32{ 0x09b2, 0x09b8, 0x09be, 0x0997, 0x09c1 };
pub fn bnmath_Lcm(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 2) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Lcm(gc, argc, values);
}

pub const BnNameFuncSine = &[_]u32{ 0x09b8, 0x09be, 0x0987, 0x09a8 };
pub fn bnmath_Sine(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Sine(gc, argc, values);
}

pub const BnNameFuncCosine = &[_]u32{ 0x0995, 0x09b8 };
pub fn bnmath_Cosine(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Cosine(gc, argc, values);
}

pub const BnNameFuncTangent = &[_]u32{ 0x099f, 0x09cd, 0x09af, 0x09be, 0x09a8 };
pub fn bnmath_Tangent(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Tangent(gc, argc, values);
}

pub const BnNameFuncDegree = &[_]u32{ 0x09a1, 0x09bf, 0x0997, 0x09cd, 0x09b0, 0x09bf };
pub fn bnmath_Degree(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Degree(gc, argc, values);
}

pub const BnNameFuncRadians = &[_]u32{ 0x09b0, 0x09c7, 0x09a1, 0x09bf, 0x09df, 0x09be, 0x09a8 };
pub fn bnmath_Radians(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Radians(gc, argc, values);
}

pub const BnNameFuncNumber = &[_]u32{ 0x09b8, 0x0982, 0x0996, 0x09cd, 0x09af, 0x09be };
pub fn bnmath_Number(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Number(gc, argc, values);
}

pub const BnNameFuncAbs = &[_]u32{ 0x09aa, 0x09b0, 0x09ae };
pub fn bnmath_Abs(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Abs(gc, argc, values);
}

pub const BnNameFuncRound = &[_]u32{ 0x09b0, 0x09be, 0x0989, 0x09a8, 0x09cd, 0x09a1 };
pub fn bnmath_Round(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Round(gc, argc, values);
}

pub const BnNameFuncFloor = &[_]u32{ 0x09ab, 0x09cd, 0x09b2, 0x09cb, 0x09b0 };
pub fn bnmath_Floor(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Floor(gc, argc, values);
}

pub const BnNameFuncCeil = &[_]u32{ 0x09b8, 0x09bf, 0x09b2 };
pub fn bnmath_Ceil(gc: *Gc, argc: u8, values: []PValue) PValue {
    if (argc != 1) {
        return PValue.makeError(
            gc,
    ...
    return enmod.math_Ceil(gc, argc, values);
}
