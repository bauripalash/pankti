...
typedef enum PanDiagCode{
    ...
    // নথি.লেখা(নথির_পথ, তথ্য) কাজের প্রথম প্রেরণমান অর্থাৎ নথির পথ একটি কথারাশি হওয়া উচিত ছিল কিন্তু একটি %s-জাতিয় রাশি পাওয়া
    RT_STDFILE_WRITE_FILENAME_STR,
    // নথি.লেখা(নথির_পথ, তথ্য) কাজের দ্বিতীয় প্রেরণমান অর্থার তথ্য একটি কথারাশি হওয়া উচিত ছিল কিন্তু একটি %s-জাতিয় রাশি পাওয়া
    RT_STDFILE_WRITE_CONTENT_STR,
    // নথি.লেখা(নথির_পথ, তথ্য) কাজে প্রদত্ত নথি '%s' খুঁজে পাওয়া গেলো না
    RT_STDFILE_WRITE_FILE_NOT_FOUND,
    // নথি.লেখা(নথির_পথ, তথ্য) কাজে প্রদত্ত নথির পথ '%s' ফাইল নয়
    RT_STDFILE_WRITE_ISNOT_FILE,
    // অভ্যন্তরীণ গোলমাল: নথি.লেখা(নথির_পথ, তথ্য) কাজে '%s' নথিতে তথ্য লেখা বিফল হয়েছে
