...
* লিনাক্স x86_64 64বিট: [pankti-linux64-preview.zip](https://github.com/bauripalash/pankti/releases/download/preview/pankti-linux64-preview.zip)
* সোর্স কোড: [pankti-source-preview.zip](https://github.com/bauripalash/pankti/releases/download/preview/pankti-source-preview.zip)
